...
class BilingualDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        src_text = src_target_pair['translation'][self.src_lang] #得到英语句子
        tgt_text = src_target_pair['translation'][self.tgt_lang] #得到对应意大利句子

        # Transform the text into tokens
        enc_input_tokens = self.tokenizer_src.encode(src_text).ids #得到对应英语句子中单词索引
        dec_input_tokens = self.tokenizer_tgt.encode(tgt_text).ids #得到对应意大利句子中单词索引
